...
style frame_simple:
    xpadding 25
    ypadding 25
    background Frame("gui/frame_simple.png", 68, 68, 68, 68, tile=True)

style frame_thin_line:
    xpadding 11
    ypadding 11
    background Frame("gui/frame_thin_line.png", 68, 68, 68, 68, tile=True)

style frame_empty:
    xpadding 0
    ypadding 0
    background Frame("gui/Empty.png")
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "gui/frame.png"], gui.confirm_frame_borders, tile=True)
